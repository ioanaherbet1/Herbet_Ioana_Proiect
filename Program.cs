...
using Herbet_Ioana_Proiect.Hubs;
...
builder.Services.AddDbContext<DressesContext>(options =>options.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection")));
